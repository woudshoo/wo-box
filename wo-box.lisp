...
#+nil	(let ((text (cl-typesetting:compile-text (:font "URWPalladioL-Roma" :font-size 12.0)
	...
	(let* ((text (cl-typesetting:compile-text () "Hallo"))
	       (lines (car (cl-typesetting::fit-lines text 10000 10000)))
	       (box (make-instance 'cl-typesetting::hbox :boxes (cl-typesetting::boxes lines))))
	  (cl-typesetting::do-layout box)
	  (cl-typesetting::stroke lines 0 40))
	)
